...
19. **Protocolo Obligatorio de Rectificación Previa & Verificación Cruzada Multicapa antes del Envío de Correos**:
    - **Principio de Veracidad y Fidedignidad Inviolable**: Ningún informe asistencial por correo puede emitirse si sus datos no concilian al 100% con los módulos de auditoría y consolidación oficial de MÉTRICO.
    - **Las 5 Fuentes Canónicas de Rectificación y Verificación Previa**:
      ...
      5) **Auditoría Pre-Vuelo en Despacho (`ModalConfiguracionCorreo.jsx` / `auditarIntegridadTurnoCorreo`)**: Pasarela final obligatoria que reconcilia y certifica que la suma de atenciones médicas y altas administrativas sea matemáticamente exacta al 100% de los pacientes admitidos antes de disparar la Cloud Function de despacho.
    - **Sello de Certificación Pre-Vuelo**: En la previsualización del correo, el sistema debe desplegar un sello explícito de verificación cruzada que confirme al usuario que el turno fue contrastado exitosamente contra el Histórico Mensual y la Auditoría de Demanda.
