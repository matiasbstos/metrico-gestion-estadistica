  ...
  const updatesList = [
    {
      ...
      instructivo: {
        ...
        quePuedesVer: '1) Cuatro tarjetas ordenadas idénticamente al consolidado Rayen: 1. Total Pacientes (Admitidos), 2. Completados (Atención Médica), 3. Egreso Administrativo, 4. Alta sin Atención Médica. 2) Carrusel de KPIs principales sincronizado: "Pac. Atendidos" muestra 87 y "Altas Admin" 23 pac. (20.9%), erradicando el descalce previo de 82 / 28. 3) Cuadre exacto en el turno del 06/09/2026 diurno: 87 completados, 22 egresos admin y 1 alta sin atención sobre 110 admitidos. 4) Ecuación Universal certificada con balance perfecto.',
        ejemploUso: 'En la cabecera principal de KPIs o en Centro de Verificación > Prueba de Control de Demanda, selecciona el 06/09/2026 con la franja "08:00 a 20:00 hrs". Verás los valores exactos de Rayen: 110 admitidos, 87 completados, 22 egresos administrativos y 1 alta sin atención, con ecuación cuadrada.'
      },
      changes: [
        'Unificación SSOT en useMetricoAnalytics.js: el carrusel de KPIs ahora calcula con la regla clínica canónica, mostrando 87 atendidos y 23 altas (en lugar de 82 y 28).',
