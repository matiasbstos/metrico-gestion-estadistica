      ...
      <div className="bg-card-custom p-6 rounded-3xl border border-card-custom shadow-sm no-print space-y-4 theme-transition">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
            {onOpenCorreoModal && (
              <button 
                onClick={onOpenCorreoModal}
                className="flex items-center gap-2 px-4 py-2.5 bg-indigo-500/10 text-indigo-600 dark:text-indigo-300 border border-indigo-500/20 font-bold rounded-xl text-xs hover:bg-indigo-500/20 transition-all cursor-pointer shadow-xs"
                title="Configurar programación de envío de informes por correo"
              >
                <Mail className="w-4 h-4 text-indigo-500" /> Envíos por Correo
              </button>
            )}
