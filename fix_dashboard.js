...
const startMarker = `  // =========================================================================\r
  // 1. PIPELINE DE DATOS GLOBAL`;
const endMarker = `  return { \n      florencia: { count: countFlorencia`; // this is inside rankingCentros
// Actually it's easier to regex from 1. PIPELINE DE DATOS GLOBAL all the way to `  const renderResumen = () => (`
